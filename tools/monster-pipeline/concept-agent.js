...
CRITICAL image_prompt style per stage:
- BASE (wild enemy): Dark, grotesque, gory, terrifying monster. Menacing aura, sharp edges, horror elements, intimidating presence. Think Dark Souls / eldritch horror creature style.
- DEVO1 (tamed ally): Powerful, cool, battle-ready warrior creature. Sleek and strong, but with visible traces/remnants of the original wild base form (same silhouette elements, color echoes). Think battle partner / digimon champion level.
- DEVO2 (final devolution): Maximum cute, tiny, adorable, chibi. Round shapes, big eyes, soft colors. But the previous stage's features are still clearly recognizable (miniaturized horns, tiny wings, color pattern preserved). Think baby pokemon / slime mascot.`;
