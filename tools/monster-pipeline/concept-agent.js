...
3. Devolved forms: smaller, simpler, cuter
4. Each form visually distinct
5. English image prompts in pokemon/creature style
6. Skills must be balanced and thematically fitting
7. Enemy reactions must match personality and sensory types`;
...
{"base":{"name_kr":"Korean name","name_en":"snake_case_id","desc_kr":"1-line Korean description","element":"element keyword","sensoryType":["axis1","axis2"],"personality":"one of: aggressive/timid/curious/stubborn","attackPower":5,"tamingThreshold":65,"escapeThreshold":80,"image_prompt":"pokemon style creature, detailed appearance, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, cute monster design","reactions":{"sound_good":"Korean reaction","sound_bad":"Korean reaction","temp_good":"Korean reaction","temp_bad":"Korean reaction","smell_good":"Korean reaction","smell_bad":"Korean reaction","behav_good":"Korean reaction","behav_bad":"Korean reaction","attack":"Korean attack description!","calm":"Korean calm description."}},"devolutions_1":[{"name_kr":"Korean name","name_en":"snake_case_id","desc_kr":"Korean desc","hp":28,"maxHp":28,"stats":{"gentleness":5,"empathy":5,"resilience":5,"agility":5},"devolvedName":"Korean devolved name","devolvedDesc":"Korean devolved desc","devolvedStats":{"gentleness":10,"empathy":3,"resilience":3,"agility":4},"image_prompt":"pokemon style creature, smaller simpler version, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, cute chibi monster","actions":[{"id":"skill_id","name":"Korean skill name","axis":"sound","category":"stimulate","power":12,"escapeRisk":3,"pp":8,"maxPp":8,"effects":[{"type":"calm","chance":0.2,"turns":2}],"log":"Korean action description."},{"id":"skill_id","name":"Korean skill name","axis":"behavior","category":"defend","power":8,"escapeRisk":-3,"healAmount":5,"defenseBoost":2,"pp":6,"maxPp":6,"effects":[],"log":"Korean action description."},{"id":"skill_id","name":"Korean skill name","axis":"smell","category":"capture","power":15,"escapeRisk":12,"pp":3,"maxPp":3,"effects":[],"log":"Korean action description."}]},{"name_kr":"variation B name","name_en":"snake_case_b","desc_kr":"desc","hp":25,"maxHp":25,"stats":{"gentleness":6,"empathy":4,"resilience":4,"agility":6},"devolvedName":"devolved B","devolvedDesc":"desc","devolvedStats":{"gentleness":12,"empathy":2,"resilience":3,"agility":3},"image_prompt":"pokemon style creature, different variant B, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, cute chibi monster","actions":[{"id":"b_skill1","name":"skill name","axis":"temperature","category":"stimulate","power":11,"escapeRisk":4,"pp":7,"maxPp":7,"effects":[{"type":"curious","chance":0.15,"turns":2}],"log":"action desc."},{"id":"b_skill2","name":"skill name","axis":"smell","category":"defend","power":6,"escapeRisk":-4,"healAmount":6,"defenseBoost":3,"pp":5,"maxPp":5,"effects":[],"log":"action desc."},{"id":"b_skill3","name":"skill name","axis":"behavior","category":"capture","power":14,"escapeRisk":11,"pp":3,"maxPp":3,"effects":[],"log":"action desc."}]},{"name_kr":"variation C name","name_en":"snake_case_c","desc_kr":"desc","hp":30,"maxHp":30,"stats":{"gentleness":4,"empathy":6,"resilience":6,"agility":4},"devolvedName":"devolved C","devolvedDesc":"desc","devolvedStats":{"gentleness":3,"empathy":3,"resilience":12,"agility":2},"image_prompt":"pokemon style creature, variant C appearance, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, cute chibi monster","actions":[{"id":"c_skill1","name":"skill name","axis":"sound","category":"stimulate","power":13,"escapeRisk":5,"pp":6,"maxPp":6,"effects":[{"type":"charmed","chance":0.1,"turns":3}],"log":"action desc."},{"id":"c_skill2","name":"skill name","axis":"temperature","category":"defend","power":5,"escapeRisk":-5,"healAmount":4,"defenseBoost":4,"pp":5,"maxPp":5,"effects":[{"type":"calm","chance":0.25,"turns":2}],"log":"action desc."},{"id":"c_skill3","name":"skill name","axis":"sound","category":"capture","power":16,"escapeRisk":14,"pp":2,"maxPp":2,"effects":[],"log":"action desc."}]}],"devolutions_2":[{"parent":"snake_case_id of devo1 parent","name_kr":"tiny name","name_en":"tiny_id_a1","desc_kr":"Korean desc","image_prompt":"pokemon style creature, tiny adorable blob, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, tiny adorable blob creature"},{"parent":"same parent","name_kr":"tiny name","name_en":"tiny_id_a2","desc_kr":"Korean desc","image_prompt":"pokemon style creature, tiny cute variant, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, tiny adorable blob creature"},{"parent":"snake_case_b","name_kr":"tiny name","name_en":"tiny_id_b1","desc_kr":"Korean desc","image_prompt":"pokemon style creature, tiny blob b1, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, tiny adorable blob creature"},{"parent":"snake_case_b","name_kr":"tiny name","name_en":"tiny_id_b2","desc_kr":"Korean desc","image_prompt":"pokemon style creature, tiny blob b2, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, tiny adorable blob creature"},{"parent":"snake_case_c","name_kr":"tiny name","name_en":"tiny_id_c1","desc_kr":"Korean desc","image_prompt":"pokemon style creature, tiny blob c1, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, tiny adorable blob creature"},{"parent":"snake_case_c","name_kr":"tiny name","name_en":"tiny_id_c2","desc_kr":"Korean desc","image_prompt":"pokemon style creature, tiny blob c2, simple white background, full body, facing left, front three-quarter view, game sprite, transparent background, tiny adorable blob creature"}]}`;
