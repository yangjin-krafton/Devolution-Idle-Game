  ...
  devo1: [
    {
      ...
      skillPool: ['behavior-spark', 'behavior-relay', 'behavior-stimulate', 'behavior-sweep', 'behavior-pact', 'behavior-capture', 'behavior-defend'],
    ...
    },
    {
      ...
      skillPool: ['behavior-stimulate', 'behavior-play', 'behavior-surge', 'behavior-lure', 'behavior-capture', 'behavior-vow', 'behavior-defend'],
    ...
    },
    {
      ...
      skillPool: ['behavior-defend', 'behavior-guard', 'behavior-ward', 'behavior-mend', 'behavior-stimulate', 'behavior-capture', 'behavior-bow'],
