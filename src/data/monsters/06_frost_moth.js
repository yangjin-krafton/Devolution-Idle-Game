  ...
  devo1: [
    {
      ...
      skillPool: ['temperature-breeze', 'temperature-bloom', 'temperature-heal', 'temperature-defend', 'temperature-capture', 'temperature-stimulate', 'temperature-shelter'],
      equipped: ['temperature-breeze', 'temperature-heal', 'temperature-capture'],
      actions: makeActions(['temperature-breeze', 'temperature-heal', 'temperature-capture']),
    },
    {
      ...
      skillPool: ['temperature-defend', 'temperature-ward', 'temperature-reserve', 'temperature-mend', 'temperature-stimulate', 'temperature-capture', 'temperature-mist'],
