  ...
  devo1: [
    {
      ...
      skillPool: ['sound-stimulate', 'sound-pulse', 'sound-echo-mark', 'behavior-stimulate', 'sound-capture', 'sound-finale', 'sound-defend'],
    ...
    },
    {
      ...
      skillPool: ['behavior-defend', 'behavior-guard', 'behavior-shelter', 'behavior-mend', 'sound-stimulate', 'behavior-capture', 'sound-lullaby'],
    ...
    },
    {
      ...
      skillPool: ['sound-lullaby', 'sound-bloom', 'sound-recover', 'sound-defend', 'sound-capture', 'behavior-stimulate', 'sound-guard'],
    ...
    },
    {
      ...
      skillPool: ['behavior-spark', 'behavior-relay', 'behavior-stimulate', 'behavior-sweep', 'sound-keystone', 'sound-capture', 'behavior-defend'],
