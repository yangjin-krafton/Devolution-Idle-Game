...
export default {
  ...
  wild: {
    ...
    environmentSkills: [
      { axis: 'brightness', delta: 2, log: '그림자 고양이의 눈이 빛나며 주변을 비춘다!' },
      { axis: 'sound', delta: 1, log: '그림자 고양이가 날카롭게 울음소리를 낸다!' },
    ],
  ...
  devo1: [
    ...
    },
    {
      ...
      skillPool: ['behavior-bow', 'behavior-bloom', 'behavior-guard', 'temperature-defend', 'behavior-capture', 'behavior-stimulate', 'behavior-defend', 'survey-gaze'],
