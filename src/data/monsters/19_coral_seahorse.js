...
export default {
  ...
  wild: {
    ...
    environmentPreference: {
      ...
      smell: { ideal: -1, tolerance: 0 }, humidity: { ideal: 2, tolerance: 0 }, sound: { ideal: -1, tolerance: 1 },
    },
    fleeProfile: { baseGain: 2, mismatchBonus: 1 },
    environmentSkills: [
      { axis: 'humidity', delta: -2, log: '산호 해마가 물을 흡수한다!' },
      { axis: 'brightness', delta: -1, log: '산호 해마가 몸색으로 빛을 가린다!' },
    ],
  ...
  devo1: [
    {
      ...
      skillPool: ['temperature-stimulate', 'temperature-flare', 'temperature-overdrive', 'smell-lure', 'temperature-capture', 'temperature-snare', 'smell-defend', 'survey-warmth'],
    ...
    },
    {
      ...
      skillPool: ['temperature-mist', 'temperature-bloom', 'temperature-heal', 'smell-defend', 'temperature-capture', 'temperature-stimulate', 'smell-sanctuary', 'survey-warmth'],
