...
export default {
  ...
  wild: {
    ...
    environmentPreference: {
      temperature: { ideal: 1, tolerance: 1 }, brightness: { ideal: -2, tolerance: 0 },
      smell: { ideal: 2, tolerance: 0 }, humidity: { ideal: 2, tolerance: 0 }, sound: { ideal: -1, tolerance: 1 },
    },
    fleeProfile: { baseGain: 1, mismatchBonus: 2 },
    environmentSkills: [
      { axis: 'smell', delta: -2, log: '늪 거머리가 점액을 뿜어 냄새를 지운다!' },
      { axis: 'brightness', delta: 1, log: '늪 거머리의 몸에서 인광이 빛난다!' },
    ],
  ...
  devo1: [
    {
      ...
      skillPool: ['smell-herb', 'smell-bloom', 'smell-aroma-wall', 'behavior-defend', 'smell-capture', 'smell-stimulate', 'smell-defend', 'survey-scent'],
    ...
    },
    {
      ...
      skillPool: ['smell-defend', 'smell-ward', 'smell-shelter', 'smell-mend', 'behavior-stimulate', 'smell-capture', 'behavior-bow', 'survey-scent'],
    ...
    },
    {
      ...
      skillPool: ['smell-stimulate', 'smell-spore', 'smell-trail', 'behavior-surge', 'smell-capture', 'smell-snare', 'behavior-defend', 'survey-scent'],
