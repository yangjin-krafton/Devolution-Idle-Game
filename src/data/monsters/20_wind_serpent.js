  ...
  devo1: [
    {
      ...
      hp: 22, maxHp: 22, stats: { affinity: 12, empathy: 3, endurance: 2, agility: 3, bond: 3, instinct: 3 },
      ...
      skillPool: ['behavior-stimulate', 'behavior-play', 'behavior-surge', 'sound-lure', 'behavior-capture', 'behavior-pact', 'sound-defend'],
    ...
    },
    {
      ...
      skillPool: ['behavior-defend', 'behavior-guard', 'behavior-shelter', 'behavior-mend', 'behavior-stimulate', 'behavior-capture', 'sound-ward'],
    ...
    },
    {
      ...
      skillPool: ['behavior-spark', 'behavior-tether', 'behavior-stimulate', 'sound-sweep', 'behavior-clasp', 'sound-capture', 'behavior-defend'],
